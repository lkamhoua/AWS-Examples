...
```md
aws s3 mb s3://checksums-examples-lkf-2342
```
...
```
aws s3 cp myfile.txt s3://checksums-examples-lkf-2342
aws s3api head-object --bucket checksums-examples-lkf-2342 --key myfile.txt
```
...
--bucket="checksums-examples-lkf-2342" \
--key="myfilesha1.txt" \
--body="myfile.txt" \
